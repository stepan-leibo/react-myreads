    ...
    componentDidMount() {
        getAll().then((books) => {
            ...
            this.setState({
                books: books
                //     {
                //     currentlyReading: books.filter(item => item.shelf === 'currentlyReading'),
                //     wantToRead: books.filter(item => item.shelf === 'wantToRead'),
                //     read: books.filter(item => item.shelf === 'read')
                // }
            })
        })
    }
